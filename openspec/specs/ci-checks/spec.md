...
## Purpose
Define the automated CI checks that guard `main` under the trunk-based
workflow: PR title linting (needed for `release-please` to parse Conventional
Commits), JS/TS-appropriate security scanning, and Dependabot coverage for
the npm ecosystem.
