...
export default class TemplateSelector {
    ...
    constructor(isStartupTemplateSelector: any) {
        ...
        for (var i = 0; i < PedigreeTemplates.length; ++i) {
            ...
            pictureBox.addEventListener('click', (function(box: any) {
                return function(event: any) {
                    _this._onTemplateSelected(event, box);
                };
            })(pictureBox));
        }
    }
     ...
     * @private
     */
    _onTemplateSelected(event: any, pictureBox: any): any {
        this.dialog.close();
        editor.getSaveLoadEngine().createGraphFromSerializedData((pictureBox as any).pedigreeData, false /* add to undo stack */, true /*center around 0*/);
    }
