...
export default class Workspace {
  ...
  constructor() {
    ...
    attribution.innerHTML = '&copy; 2019-2022 Gene42 Inc.';
    this.workArea.appendChild(attribution);

    (this as any).adjustSizeToScreen = this.adjustSizeToScreen.bind(this);
  ...
  generateTopMenu(): any {
    ...
    phenotipsLink.href = 'https://phenotips.com/';
  ...
  generateViewControls(): any {
    ...
    // Non-linear scale: positions [0, 0.9] → zoom coefficients [1.25x, 0.25x];
    // positions (0.9, 1] → deepest zoom 0.15x. Range uses 0–1000 integers (÷1000).
    ...
    // Wrapper with setValue API to keep existing button/zoom call sites unchanged
    this.zoomSlider = {
