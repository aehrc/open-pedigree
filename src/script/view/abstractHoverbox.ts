...
export default class AbstractHoverbox {
     ...
     */
    createButton(x: any, y: any, svgPath: any, svgPathBBox: any, attributes: any, onClick: any, className: any, title?: any): any {
        ...
        className && button.forEach(function(element: any) {
    ...
    generateHandle(type: any, startX: any, startY: any, orbX: any, orbY: any, title?: any, toHide?: any): any {
        ...
        var start = function(this: any, x: any, y: any, e: any) {
        ...
        var move = function(this: any, dx: any, dy: any) {
            if (wrongClick) {
                return;
            }
            if (!interactionStarted) {
    ...
    toggleMenu(toggled: any): any {}
    handleAction(type: any, isDragged: any, curHoveredId: any): any {}
}
