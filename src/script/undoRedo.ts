...
export default class ActionStack {
     ...
     * @method addState
     */
    addState(eventToGetToThisState: any, eventToUndo: any, serializedState: any): any {
     ...
     * @return {Number}
     */
    _combinableEvents(event1: any, event2: any): any {
